...
import com.android.prize.simple.utils.ResourcesUtils;
...
public class DataDeals {
     ...
     * 应用广告标签
     */
    private final String TAG_APP_PRD = "app_prd";
    /**
     * 联系人标签
     */
    ...
    public int loadFavorites(int xmlResourceId) {
        ...
        Log.i(TAG, "xmlResourceId:" + xmlResourceId);
        ...
        try {
            ...
            while (((type = parser.next()) != XmlPullParser.END_TAG || parser
                ...
                Log.i(TAG, "typedArray" + a.length() +a.getString(R.styleable.Favorite_screen));
                ...
                try {
                    item.des = a.getString(R.styleable.Favorite_des);
                    String bg_res_str = a.getString(R.styleable.Favorite_bg);
                    if (bg_res_str != null) {
                        int id = ResourcesUtils.getDrableId(mContext, bg_res_str);
                        item.bgResId = id;
                    }
                } catch (Exception e) {
                ...
                } else if (TAG_APP_PRD.equals(name)) {
                    item.type = IConstant.TYPE_APP;
                    item.canDel = false;
                    added = addApp(item, packageManager, intent);
     ...
     * @return 成功加载了多少条
     */
    public int loadFavoriteds(int xmlResourceId) {
