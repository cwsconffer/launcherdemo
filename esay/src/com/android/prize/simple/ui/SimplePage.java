 ...
 *
 */
public class SimplePage extends ViewGroup {
	...
	public SimplePage(Context ctx) {
		this(ctx, null);
		// TODO Auto-generated constructor stub
	}

	public SimplePage(Context ctx, AttributeSet attrs) {
		this(ctx, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public SimplePage(Context ctx, AttributeSet attrs, int defStyleAttr) {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
			...
			//add by zhouerlong super  1080*540
			//add by zhouerlong super  1080*540
                }
                else { //整屏
...
//            maxHeight = Math.max(maxHeight, child.getMeasuredHeight());
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new SimplePage.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof SimplePage.LayoutParams;
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new SimplePage.LayoutParams(p);
    }
