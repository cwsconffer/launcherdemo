...
public class SettingsActivity extends Activity {
    ...
    private View speakManagerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.i(TAG, "SettingsActivity,启动");
        initStatusBar();
